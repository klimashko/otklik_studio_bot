LEXICON_RU: dict[str, str] = {
    ...
    'text_about_studio': 'Фотостудия автопортрета ОТКЛИК, Первая студия в г. Обнинске,\n'
                         'где ты сам себе фотограф, только Ты, пульт и Зеркало.\n\n'
                         'Любишь позировать перед зеркалом?\n'
                         'Тогда этот совершенно новый формат точно для тебя!\n'
                         'Просто смотри в зеркало и жми на кнопку.\n\n'
                         'Ты будешь сразу видеть классный кадр,\n'
                         'ведь рядом с зеркалом мы предусмотрели монитор!\n\n'
                         'Свет и камера уже профессионально настроены,\n'
                         'остается лишь позировать и кликать на кнопку 😉',
