...
from otklik_studio_bot.keyboards.keyboards import primary_kb, services_prices_kb, kb_fotosessions, kb_certificates, contacts_kb, kb_about_studio, faq_keyboard
